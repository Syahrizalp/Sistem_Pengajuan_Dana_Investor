 ...
 * @author Acer
 */
public class FormSignUpKaryawan2 extends javax.swing.JFrame {
private String userIdi;
     ...
     * Creates new form FormSignUp1
     */
    public FormSignUpKaryawan2(String userIdi) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbjabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Jabatan -", "Supervisor", "Analis" }));
...
String username = txtusername.getText();
        ...
        try (Statement stmt = conek1.GetConnection().createStatement()) {
            ...
            if (role.equals("Supervisor")) {
                queryDetail = "INSERT INTO supervisor (id_supervisor, username, nama, alamat, email, no_telepon, id_investor) VALUES ('"
                   +id+ "', '"     + username + "', '" + nama + "', '" + address + "', '" + email + "', '" + phone + "', '" + userIdi + "')";
            } else if (role.equals("Analis")) {
                queryDetail = "INSERT INTO analis (id_analis, username, nama, alamat, email, no_telepon, id_investor) VALUES ('"
                    +id+ "', '"      + username + "', '" + nama + "', '" + address + "', '" + email + "', '" + phone + "', '" + userIdi + "')";
            }
            stmt.executeUpdate(queryDetail);

            JOptionPane.showMessageDialog(null, "Akun berhasil dibuat!Login sekarang ");
            LoginKaryawan2 LK = new LoginKaryawan2(userIdi);
            LK.setVisible(true);
            this.dispose();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String userIdi =null;
                new FormSignUpKaryawan2(userIdi).setVisible(true);
            }
        });
    }
