 ...
 * @author Acer
 */
public class FormSignUpKaryawan1 extends javax.swing.JFrame {
private String userIdP;
     ...
     * Creates new form FormSignUp1
     */
    public FormSignUpKaryawan1(String userIdP) {
        initComponents();
        this.userIdP = userIdP;
        System.out.println(userIdP);
    }
    ...
    private void initComponents() {
        ...
        cmbjabatan.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "- Jabatan -", "Pelaksana", "Admin Pelaksana", "Manajer", "Finance" }));
        jPanel1.add(cmbjabatan, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 312, 140, 30));
...
String username = txtusername.getText();
        ...
        String role = (String) cmbjabatan.getSelectedItem();
 System.out.println(userIdP);
        ...
        try (Statement stmt = conek1.GetConnection().createStatement()) {
            ...
            // Masukkan data ke tabel spesifik berdasarkan role
            String queryDetail = "";
            if (role.equals("Pelaksana")) {
                queryDetail = "INSERT INTO pelaksana (id_pelaksana, username, nama_pelaksana,"
                        + " alamat, email, no_telepon, id_perusahaan) VALUES ('"
                   +id+ "', '"+ username + "', '" + nama + "', '" + address + "', '" + email 
                        + "', '" + phone + "', '" + userIdP + "')";
            } else if (role.equals("Admin Pelaksana")) {
                queryDetail = "INSERT INTO admin_pelaksana (id_admin, username, Nama, Alamat, email,"
                        + " No_Telp, id_perusahaan) VALUES ('"
                    +id+ "', '"+ username + "', '" + nama + "', '" + address + "', '" + email 
                        + "', '" + phone + "', '" + userIdP + "')";
            }else if (role.equals("Manajer")) {
                queryDetail = "INSERT INTO manajer (id_manajer, username, Nama, alamat, email, no_telepon,"
                        + " id_perusahaan) VALUES ('"
                    +id+ "', '"+ username + "', '" + nama + "', '" + address + "', '" + email 
                        + "', '" + phone + "', '" + userIdP + "')";
            }else if (role.equals("Finance")) {
                queryDetail = "INSERT INTO finance (id_finance, username, Nama, alamat, email, no_telepon,"
                        + " id_perusahaan) VALUES ('"
                    +id+ "', '"+ username + "', '" + nama + "', '" + address + "', '" + email 
                        + "', '" + phone + "', '" + userIdP + "')";
            }
            ...
            stmt.executeUpdate(queryLogin);
                                     stmt.executeUpdate(queryDetail);


            JOptionPane.showMessageDialog(null, "Akun berhasil dibuat!Login sekarang ");
            LoginKaryawan LK = new LoginKaryawan(userIdP);
            LK.setVisible(true);
            this.dispose();
        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Terjadi kesalahan saat membuat akun." + e.getMessage());
        }
    ...
    private void b_kembaliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_kembaliActionPerformed
        LoginKaryawan sp = new LoginKaryawan(userIdP);
        sp.setVisible(true);
        this.dispose();
        // TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String userIdP =null;
                new FormSignUpKaryawan1(userIdP).setVisible(true);
            }
        });
    }
