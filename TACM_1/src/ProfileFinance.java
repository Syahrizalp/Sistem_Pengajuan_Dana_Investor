 ...
 * @author Acer
 */
public class ProfileFinance extends javax.swing.JPanel {
...
private String username;
     ...
     */
    public ProfileFinance(String username, String userId) throws SQLException {
        initComponents();
              this.userId = userId;
    ...
    String query = "UPDATE finance SET nama = '" + nama + "', alamat = '" +alamat + "', email = '" + email + "', no_telepon = '" + nomer + "' WHERE id_finance = '" + txtid.getText() + "';";
    ...
    private void loadUserProfile(String userId) throws SQLException {
      try {
        ...
        ResultSet rs = statement.executeQuery("select * from finance wHERE username = '" + username +"';");
        
        if (rs.next()) {
                String id = rs.getString("id_finance");
