 ...
 * @author Acer
 */
public class ProfilePelaksana extends javax.swing.JPanel {
...
private String username;
     ...
     */
    public ProfilePelaksana(String username, String userId) throws SQLException {
        initComponents();
              this.userId = userId;
    ...
    String query = "UPDATE pelaksana SET nama_pelaksana = '" + nama + "', alamat = '" +alamat + "', email = '" + email + "', no_telepon = '" + nomer + "' WHERE id_pelaksana = '" + txtid.getText() + "';";
    ...
    private void loadUserProfile(String userId) throws SQLException {
      try {
        ...
        ResultSet rs = statement.executeQuery("select * from Pelaksana wHERE username = '" + username +"';");
        
        if (rs.next()) {
                String id = rs.getString("id_pelaksana");
                String fullName = rs.getString("nama_pelaksana");
