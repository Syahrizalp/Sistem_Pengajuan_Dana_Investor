 ...
 * @author Acer
 */
public class ProfileAdmin1 extends javax.swing.JPanel {
...
private String username;
     ...
     */
    public ProfileAdmin1(String username, String userId) throws SQLException {
        initComponents();
              this.userId = userId;
    ...
    String query = "UPDATE admin_pelaksana SET nama = '" + nama + "', alamat = '" +alamat + "', email = '" + email + "', No_telp = '" + nomer + "' WHERE id_admin = '" + txtid.getText() + "';";
    ...
    private void loadUserProfile(String userId) throws SQLException {
      try {
        ...
        ResultSet rs = statement.executeQuery("select * from admin_pelaksana wHERE username = '" + username +"';");
