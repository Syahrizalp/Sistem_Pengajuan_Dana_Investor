 ...
 * @author Acer
 */
public class ProfileSupervisor extends javax.swing.JPanel {
...
private String username;
     ...
     */
    public ProfileSupervisor(String username, String userId) throws SQLException {
        initComponents();
              this.userId = userId;
    ...
    String query = "UPDATE supervisor SET nama = '" + nama + "', alamat = '" +alamat + "', email = '" + email + "', no_telepon = '" + nomer + "' WHERE id_supervisor = '" + txtid.getText() + "';";
    ...
    private void loadUserProfile(String userId) throws SQLException {
      try {
        ...
        ResultSet rs = statement.executeQuery("select * from supervisor wHERE username = '" + username +"';");
